...
data_path = '../datasets/airline-delay-analysis/'
...
if __name__ == '__main__':
    ...
    train_path = os.path.join(new_dataset_path, './minor/train.csv')
    test_path = os.path.join(new_dataset_path, './minor/test.csv')
    sample(data, ('2009-01-01', '2019-01-01'),
           0.0002, train_path, random_seed)
    sample(data, ('2019-01-01', '2020-01-01'),
           0.0005, test_path, random_seed)