...
Save_Path = '../models/'
Log_Path = '../models/log-2023-04-30-LinearRegression.log'
...
model = RegressionModel(LinearRegression, trainset, testset)
lr = model.model
grid = ParamGridBuilder().addGrid(lr.tol, [10000, 1000, 100, 10, 1]).build()
